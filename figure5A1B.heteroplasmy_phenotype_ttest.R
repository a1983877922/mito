...
bed2pos3 <- bed_df %>% 
  ...
  rename(HL16179 = HL ,
         HID = Sample)
venn <- list(
  HL14755 = bed2pos1_filt,
  HL14775 = bed2pos2_filt
) 
...
# ##Plot韦恩图########
pv <- ggVennDiagram(venn, 
              category.names = c("MT14755", "MT14775"),
              set_size = 4,
              set_color = "black",
              label_size = 4,
              edge_size = 1,
              edge_lty = "longdash",
              edge_color = "gray60",
              set_pos = list(c(0.3, 0.5), c(0.7, 0.5))) +  # 关键Adjust
  scale_fill_gradient(name = "Count", low = "#CC0C00FF", high = "#5C88DAFF") +
  labs(title = "Overlap between patients carrying MT14755 and MT14775 variant") +
  theme(plot.title = element_text(hjust = 0.5, size = 20, face = 'bold'),
        axis.text = element_blank(),
        axis.title = element_blank())
pv

# ggsave(pv,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Venn between MT14755 and MT14775.pdf",
...
p11 <- ggbetweenstats(
  ...
  ggplot.component = list(
    scale_x_discrete(labels = c("MT14755-MUT", "NO-MUT")),
  ...
  ggsignif::geom_signif(
    comparisons = list(c("MT14755-MUT", "NO-MUT")),  # SpecifyCompare组
...
p11
p21
ggsave(p11,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.HbF across MT14755 in β0β0.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
ggsave(p21,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.HbF across MT14755 in β0β+.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)

######HL14755###Soluble_transferrin_receptor######
p12 <- ggbetweenstats(
  data = input5,
  x = group,
...
p22
p12
ggsave(p12,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Soluble_transferrin_receptor across MT14755 in β0β0.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
ggsave(p22,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Soluble_transferrin_receptor across MT14755 in β0β+.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)

######HL14755###Serum_Ferritin######
p13 <- ggbetweenstats(
  data = input5,
  x = group,
  ...
  ggplot.component = list(
    scale_x_discrete(labels = c("MT14755-MUT", "NO-MUT")),
    scale_y_continuous(limits = c(0, 18000)),  # Add这行Sety轴范围
    theme(axis.text= element_text(size = 15, face = "bold"),
          axis.title.y.right = element_blank(), 
          axis.text.y.right = element_blank(), 
          axis.ticks.y.right = element_blank(), 
  ...
  ggsignif::geom_signif(
    ...
    test = "wilcox.test",  # 使用非参数test
    map_signif_level = TRUE,  # 显示星号（*）而非 p 值
    y_position = 16000,         # Adjust标记的 y 轴Position
    tip_length = 0.01,       # Adjust横线两端的短竖线长度
    textsize = 5,            # Adjust文本大小
    vjust = 0.2              # Adjust文本垂直Position
  )
...
p23
p13
ggsave(p13,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Serum Ferritin across MT14755 in β0β0.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
ggsave(p23,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Serum Ferritin across MT14755 in β0β+.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
...
p24
p14
ggsave(p14,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Iron across MT14755 in β0β0.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
ggsave(p24,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Iron across MT14755 in β0β+.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
...
ggsave(p15,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Transferrin across MT14755 in β0β0.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
ggsave(p25,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Transferrin across MT14755 in β0β+.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
...
ggsave(p16,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Annual transfusions across MT14755 in β0β0.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
ggsave(p26,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.Annual transfusions across MT14755 in β0β+.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
...
p17
p27
ggsave(p17$plot,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.survplot across MT14755 in β0β0.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
ggsave(p27$plot,filename ="D:\\biosoft\\1000thal\\mtDNA\\figure/figure5G.survplot across MT14755 in β0β+.pdf",
       device = pdf,width = 12,height = 8,dpi = 600)
